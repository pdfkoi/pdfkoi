...
export const toolContentZhTw: Record<string, ToolContent> = {
  ...
  'merge-pdf': {
    ...
    description: `
      ...
      <p>你可以先調整檔案順序，再一次合併成新的 PDF。這類需求常見於報告附件整理、掃描文件整合、發票彙總與資料歸檔。</p>
    ...
    faq: [
      ...
      { question: '可以一次合併多個 PDF 嗎？', answer: '可以，你可以同時上傳多份 PDF，再依需求合併成單一文件。' },
    ],
  },
  'split-pdf': {
    ...
    description: `
      ...
      <p>這特別適合長篇報告、合約、教材、掃描文件與多頁資料整理。當你只想分享其中幾頁，或把一份大 PDF 分成幾個小檔案時會更方便。</p>
    ...
    faq: [
      ...
      { question: '可以把 PDF 拆成單獨頁面嗎？', answer: '可以，選擇逐頁輸出後，每一頁都會生成獨立檔案。' },
  ...
  'compress-pdf': {
    ...
    description: `
      ...
      <p>這個工具特別適合掃描文件、申請資料、報告與表單。相比單純追求最小檔案，它更注重在可讀性與檔案大小之間取得平衡。</p>
    ...
    faq: [
      { question: '如何把 PDF 壓縮到方便寄送？', answer: '上傳檔案後選擇壓縮等級，再下載較小的 PDF，通常中等壓縮最適合寄送。' },
  ...
  'jpg-to-pdf': {
    ...
    description: `
      ...
      <p>不論是證件照片、截圖、掃描圖片，還是手機拍攝的紙本資料，都能先排序再匯出成一份 PDF。這比傳送多張零散圖片更方便審核、列印與保存。</p>
    ...
    faq: [
      ...
      { question: '手機拍攝的資料照片也能直接轉成 PDF 嗎？', answer: '可以，把 JPG 照片上傳後就能直接合併成一份 PDF。' },
    ],
  },
  'pdf-to-jpg': {
    ...
    description: `
      ...
      <p>這個工具適合課件、海報、宣傳頁、報告頁面與快速預覽。當 PDF 不如圖片方便傳送時，轉成 JPG 會更靈活。</p>
    ...
    faq: [
      ...
      { question: 'PDF 每一頁都會產生獨立圖片嗎？', answer: '會，多頁 PDF 通常會按頁生成多張獨立 JPG 圖片。' },
  ...
  'pdf-to-docx': {
    ...
    description: `
      ...
      <p>這個工具適合履歷更新、合約修訂、報告整理與表單再編輯。相比手動複製貼上，先轉成可編輯 Word 往往更省時間。</p>
    ...
    faq: [
      ...
      { question: '轉成 Word 後格式會保留嗎？', answer: '一般文件通常能較好保留結構，但複雜表格、分頁與掃描文件仍可能需要微調。' },
    ],
  },
};
